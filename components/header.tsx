...
export default function Header() {
  ...
  const fullText =
    "안녕하세요! 성장해가고 있는 개발자 김예린입니다. 프론트/서비스 기획을 중점으로 각종 프로젝트 및 해커톤을 진행하였으며 현재 LG U+ 유레카 부트캠프에 참여하며 프론트 뿐만 아니라 백엔드, UI/UX 설계, 보안 기본 지식을 갖춘 등 IT 인재로 성장하고 있습니다."
  ...
  return (
    <div className="relative">
      ...
      {showScrollIndicator && (
        <div className="absolute bottom-[-9px] left-1/2 transform -translate-x-1/3 animate-bounce">
